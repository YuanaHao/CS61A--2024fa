...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        if amount != 0:
            self.transactions.append(Transaction(None, self.balance - amount, self.balance))
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.holder, self.balance, self.balance))
            return 'Insufficient funds'
        self.balance = self.balance - amount
        if amount != 0:
            self.transactions.append(Transaction(self.holder, self.balance + amount, self.balance))        
        return self.balance
